			...
			<div class="box-body">
				...
				<div class="row clearfix">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<input type="text" name="jadwal_kunjung" value="<?php echo ($this->input->post('jadwal_kunjung') ? $this->input->post('jadwal_kunjung') : $m_jadwal_praktek_antrian['jadwal_kunjung']); ?>" class="form-control" id="jadwal_kunjung" required/>
						</div>
					</div>
				</div>
				<div class="row clearfix">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<select name="metode_pembayaran_fk" class="form-control" required>
								...
								{
									$selected = ($m_metode_pembayaran['pk'] == $m_jadwal_praktek_antrian['metode_pembayaran_fk']) ? ' selected="selected"' : "";
