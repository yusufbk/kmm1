    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Perawat Tambah</h3>
            </div>
            <?php echo form_open('perawat/add'); ?>
          	<div class="box-body">
				...
				<div class="row clearfix">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<input type="date" name="tanggal_registrasi" value="<?php echo $this->input->post('tanggal_registrasi'); ?>" class="form-control" id="tanggal_registrasi" />
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				<div class="row clearfix">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<!-- <div class="form-group">
							<input type="text" name="golongan_darah" value="<?php echo $this->input->post('golongan_darah'); ?>" class="form-control" id="golongan_darah" />
						</div> -->
