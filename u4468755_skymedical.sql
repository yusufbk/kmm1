...
--
-- Host: localhost:3306
-- Generation Time: 25 Des 2017 pada 09.43
...
(49, 'PA003', '2017-06-09', '0272333111', 'Pasien Testing', 'Jl. Ir. Soekarno', 'Solobaru', 'Cemani', 'Sukoharjo', 'Jawa Tengah', 'O', 33, 'pasien2', '123456', '-', '1', 'pasien'),
...
--
ALTER TABLE `m_perawat_pelayanan`
  MODIFY `pk_perawat_pelayanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;COMMIT;
